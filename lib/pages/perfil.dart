...
class _PerfilPageState extends State<PerfilPage> {
  ...
  FirebaseAuth.instance.currentUser().then((FirebaseUser user) {
      ...
      DocumentSnapshot usuario = await Firestore.instance.collection('Usuarios').document(usuarioCarregado.uid).get();
  ...
  void _salvarDadosAlterados(context) async {
    ...
    await Firestore.instance.collection('Usuarios').document(usuarioCarregado.uid).updateData(
      {
        "nome": _nome,
        "email": _email,
        "telefone": _telefone,
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: SizedBox(
                                        width: 250,    
                                        child: Material (                          
                                          elevation: editarNome == false ? 0 : 2.0,
                                          shadowColor: Colors.grey,
                                          borderRadius: BorderRadius.all(Radius.circular(30.0)),
                                          child: TextFormField(
                                            enabled: editarNome == false ? false : true,
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: SizedBox(
                                        width: 250,    
                                        child: Material (                          
                                          elevation: editarEmail == false ? 0 : 2.0,
                                          shadowColor: Colors.grey,
                                          borderRadius: BorderRadius.all(Radius.circular(30.0)),
                                          child: TextFormField(                                          
                                            enabled: editarEmail == false ? false : true,
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: SizedBox(
                                        width: 250,    
                                        child: Material (                          
                                          elevation: editarTelefone == false ? 0 : 2.0,
                                          shadowColor: Colors.grey,
                                          borderRadius: BorderRadius.all(Radius.circular(30.0)),
                                          child: TextFormField(                                            
                                            enabled: editarTelefone == false ? false : true, 
