                      ...
                      child: GestureDetector(
                          onTap: (){
                            showDialog(
                              ...
                              builder: (context) => 
                                AlertDialog(
                                  title: Text("Cancelar Consulta", style: TextStyle(color: Color(0xFF1EC772))),
                                  content: Text("Entre em contato com a Clínica", style: TextStyle(color: Color(0xFF969696))),
                                  actions: <Widget>
                                  [
                                    FlatButton(
                                      onPressed: () => Navigator.pop(context, true),
                                      child: Text("OK"),
                                      textColor: Color(0xFF1EC772),
                                      )
                                  ], 
                                ),
                            );
